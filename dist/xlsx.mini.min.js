...
function make_xlsx_lib(e) {
  ...
  function ee(e, r) {
    ...
    return (
      (t - (Z + (e.getTimezoneOffset() - q.getTimezoneOffset()) * 6e4)) /
      (24 * 60 * 60 * 1e3)
    );
  }
  function re(e) {
  ...
  function _e(e, r, t) {
    ...
    if (r.charCodeAt(0) === 36)
      return "$" + _e(e, r.substr(r.charAt(1) == " " ? 2 : 1), t);
    var n;
    var i,
      s,
      l,
    ...
    if ((i = r.match(/^#,##0\.([#0]*0)$/))) {
      return t < 0
        ? "-" + _e(e, r, -t)
        : ce("" + (Math.floor(t) + Se(t, i[1].length))) +
            "." +
            P(xe(t, i[1].length), i[1].length);
    }
    ...
    if ((i = r.match(/^([#0?]+)( ?)\/( ?)([#0?]+)/))) {
      ...
      if (f.length < i[4].length)
        f = ye(i[4].substr(i[4].length - f.length)) + f;
      n += f;
      return n;
    }
    if ((i = r.match(/^# ([#0?]+)( ?)\/( ?)([#0?]+)/))) {
  ...
  function Fe(e, r, t) {
    ...
    if (r.charCodeAt(0) === 36)
      return "$" + Fe(e, r.substr(r.charAt(1) == " " ? 2 : 1), t);
    var n;
    var i,
      s,
      l,
    ...
    switch (r) {
      ...
      default:
        if (r.match(/\.[0#?]*$/))
          return (
            Fe(e, r.slice(0, r.lastIndexOf(".")), t) +
            ye(r.slice(r.lastIndexOf(".")))
          );
    }
    throw new Error("unsupported format |" + r + "|");
  }
  ...
  var Ye = (function Ac() {
    ...
    function R(e, r) {
      ...
      for (s = 0; s < t.length; ++s) {
        if ((l ? t[s].replace(M, "!") : t[s]).replace(O, "") == i)
          return e.FileIndex[s];
        if ((l ? a[s].replace(M, "!") : a[s]).replace(O, "") == i)
          return e.FileIndex[s];
      }
      return null;
    }
    ...
    function Ue(e, r) {
      ...
      for (var o = 1; o < e.FullPaths.length; ++o) {
        ...
        var u = 0,
          ...
          p = 0;
        for (var d = 0; d <= h; ++d)
          if ((p = f.charCodeAt(d)) >= 32 && p < 128) ++u;
        var m = u >= (h * 4) / 5;
        n.push(a);
  ...
  function sr(e, r) {
    ...
    var a =
      ir.getTime() + (e.getTimezoneOffset() - ir.getTimezoneOffset()) * 6e4;
    return (t - a) / (24 * 60 * 60 * 1e3);
  }
  var lr = new Date();
  var or =
    ir.getTime() + (lr.getTimezoneOffset() - ir.getTimezoneOffset()) * 6e4;
  ...
  function wt(e, r, t) {
    return (
      ...
      (t != null ? bt(t) : "") +
      (r != null
        ? (r.match(vt) ? ' xml:space="preserve"' : "") + ">" + r + "</" + e
        : "/") +
      ">"
    );
  }
  ...
  function Kt() {
    ...
    Ht = function (e, r) {
      var t = ea(e, r);
      return t > 0
        ? $cptable.utils.decode(1200, e.slice(r + 4, r + 4 + t))
        : "";
    };
    Xt = function (e, r) {
      var t = ea(e, r);
    ...
    (e.match(zr) || []).forEach(function (e) {
      ...
      switch (a[0].replace(Ur, "<")) {
        ...
        case "<Default":
          ...
          break;
        case "<Override":
          if (r[cn[a.ContentType]] !== undefined)
            r[cn[a.ContentType]].push(a.PartName);
          break;
      }
    });
  ...
  function bn(e, r, t, a, n, i) {
    ...
    n.Target = t;
    if (i) n.TargetMode = i;
    else if ([dn.HLINK, dn.XPATH, dn.XMISS].indexOf(n.Type) > -1)
  ...
  function Bn(e) {
    var r = [
      Rr,
      wt("Properties", null, { xmlns: Ct.CUST_PROPS, "xmlns:vt": Ct.vt }),
    ];
    if (!e) return r.join("");
    var t = 1;
  ...
  var zn = (function () {
    ...
    function a(r, t) {
      ...
      while (n.l < m && n[n.l] != 13) {
        d = {};
        d.name = $cptable.utils
          .decode(h, n.slice(n.l, n.l + v))
          .replace(/[\u0000\r\n].*$/g, "");
        n.l += v;
      ...
      while (c-- > 0) {
        ...
        for (b = 0; b != p.length; ++b) {
          ...
          switch (p[b].type) {
            ...
            case "Y":
              a[g][b] =
                y._R(4, "i") / 1e4 + (y._R(4, "i") / 1e4) * Math.pow(2, 32);
              break;
            case "O":
              a[g][b] = -y._R(-8, "f");
              break;
    ...
    function i(e, r) {
      ...
      function b() {
        ...
        if (r.length === 0) a.t = "z";
          ...
          if (t.cellText !== false)
            a.w = Be(a.z, a.v instanceof Date ? sr(a.v) : a.v);
  ...
  function Zn(e, r) {
    ...
    if (e.match(/^\s*<(?:\w+:)?t[^>]*>/)) {
      a.t = Gr(
        ot(e.slice(e.indexOf(">") + 1).split(/<\/(?:\w+:)?t>/)[0] || "")
      );
      a.r = ot(e);
      if (t) a.h = Qr(a.t);
    } else if (e.match(Kn)) {
      a.r = ot(e);
      a.t = Gr(
        ot((e.replace(qn, "").match(Jn) || []).join("").replace(zr, ""))
      );
      if (t) a.h = Yn(Gn(a.r));
    }
    return a;
        ...
        case "<color":
          ...
          if (l.rgb) i.color.rgb = l.rgb.slice(-6);
            ...
            if (l.theme && t.themeElements && t.themeElements.clrScheme) {
              i.color.rgb = ci(
                t.themeElements.clrScheme[i.color.theme].rgb,
                i.color.tint || 0
              );
            }
          }
    ...
    (e[0].match(zr) || []).forEach(function (e) {
      ...
      switch (Hr(i[0])) {
        ...
        case "<xf/>":
          a = i;
          delete a[0];
          for (s = 0; s < Di.length; ++s)
            if (a[Di[s]]) a[Di[s]] = parseInt(a[Di[s]], 10);
  ...
  function Qi(e, r) {
    ...
    var n = [
      ...
      wt("o:shapelayout", wt("o:idmap", null, { "v:ext": "edit", data: e }), {
        "v:ext": "edit",
      }),
      wt(
        "v:shapetype",
  ...
  function ns(e, r, t) {
    var a = [
      Rr,
      wt("ThreadedComments", null, { xmlns: Ct.TCMNT }).replace(/[\/]>/, ">"),
    ];
    e.forEach(function (e) {
      var n = "";
  ...
  function Xs(e, r, t, a, n, i, s) {
    ...
    if (k)
      for (p = 0; p != k.length; ++p)
        y[p] = Ma(k[p].slice(k[p].indexOf('"') + 1));
    var x = f.match(Bs);
    if (x) el(l, x, a);
    var S = f.match(Ws);
    ...
    if (o["!links"].length > 0) {
      ...
      o["!links"].forEach(function (e) {
        ...
        if ((h = e[1].Target.indexOf("#")) > -1)
          p.location = Kr(e[1].Target.slice(h + 1));
  ...
  function Fl(e) {
    ...
    for (var t = 0; t < e.SheetNames.length; ++t)
      Ps(e.Sheets[e.SheetNames[t]], e.SheetNames[t], t);
  }
  var Dl = /<\w+:workbook/;
  function Ol(e, r) {
  ...
  function Zl(e, r) {
    ...
    for (s = 0; s < o.length; ++s) {
      ...
      for (l = 0; l < b.length; ++l) {
        ...
        var y = w,
          k = 0;
        while (y.charAt(0) == "<" && (k = y.indexOf(">")) > -1)
          y = y.slice(k + 1);
  ...
  function Ql(e, r, t, a) {
    ...
    for (var s = r.s.c; s <= r.e.c; ++s) {
      ...
      var h =
        (u && u.v != null && (u.h || Qr(u.w || (Pa(u), u.w) || ""))) || "";
      var p = {};
      if (l > 1) p.rowspan = l;
      if (o > 1) p.colspan = o;
    ...
    while ((v = St.exec(a)))
      switch ((v[3] = v[3].replace(/_.*$/, ""))) {
        ...
        case "行":
          ...
          if (N < 10)
            for (V = 0; V < N; ++V) if (A > 0) M[S + V] = { level: A };
          C = -1;
          break;
        ...
        case "数据":
          if (v[0].charAt(v[0].length - 2) === "/") {
            ...
            if (b["number-columns-repeated"])
              P = parseInt(b["number-columns-repeated"], 10);
            switch (g.t) {
              case "boolean":
                g.t = "b";
        ...
        case "a":
          if (v[1] !== "/") {
            ...
            if (L.Target.charAt(0) == "#" && L.Target.indexOf(".") > -1) {
              ...
              L.Target = "#" + B[0] + "!" + B[1];
            } else if (L.Target.match(/^\.\.[\\\/]/))
              L.Target = L.Target.slice(3);
          }
          break;
    ...
    var a = function (a, n, i) {
      ...
      for (; l <= c.e.r; ++l) {
        ...
        for (; o <= c.e.c; ++o) {
          ...
          s.push(
            "          " + wt("table:table-cell", wt("text:p", k, {}), v) + "\n"
          );
        }
  ...
  function Ao(e, r) {
    ...
    if (r.bookDeps && n.calcchain)
      v = Wl(Er(e, _o(n.calcchain)), n.calcchain, r);
    var g = 0;
    var b = {};
    var w, y;
    {
    ...
    if (r && r.bookVBA) {
      ...
      else if (n.defaults && n.defaults.bin === ls)
        m.vbaraw = Er(e, "xl/vbaProject.bin", true);
    }
    return m;
  }
  function To(e, r) {
  ...
  function Fo(e, r) {
    ...
    for (l = 1; l <= e.SheetNames.length; ++l) {
      ...
      if (u) {
        ...
        if (u["!legacy"]) {
          if (d)
            Mr(i, "xl/drawings/vmlDrawing" + l + ".vml", Qi(l, u["!comments"]));
        }
        delete u["!comments"];
        delete u["!legacy"];
      }
  ...
  function Do(e, r) {
    ...
    for (l = 1; l <= e.SheetNames.length; ++l) {
      ...
      if (h) {
        ...
        if (d && d.length > 0) {
          ...
          if (g) {
            ...
            bn(
              u,
              -1,
              "../threadedComments/threadedComment" + l + "." + t,
              dn.TCMNT
            );
          }
          v = "xl/comments" + l + "." + t;
        ...
        if (h["!legacy"]) {
          if (m)
            Mr(i, "xl/drawings/vmlDrawing" + l + ".vml", Qi(l, h["!comments"]));
        }
        delete h["!comments"];
        delete h["!legacy"];
      }
  ...
  function $o(e, r) {
    ...
    if ($n.indexOf(n[0]) > -1 && n[2] <= 12 && n[3] <= 31)
      return zn.to_workbook(a, t);
    return Bo(e, a, t, i);
  }
  function zo(e, r) {
      ...
      for (var d = r.s.c; d <= r.e.c; ++d) {
        ...
        if (i[d] != null) {
          if (v == null) {
            ...
            h[i[d]] =
              f && (m.t !== "n" || (m.t === "n" && l.rawNumbers !== false))
                ? v
                : Pa(m, v, l);
          }
          if (v != null) u = false;
  ...
  function oc(e, r, t) {
    ...
    var d = ya(s);
    if (n)
      for (p = 0; p < h.length; ++p) i[Ca(p + l) + d] = { t: "s", v: h[p] };
    i["!ref"] = Oa(f);
    return i;
  }
  function cc(e, r) {
